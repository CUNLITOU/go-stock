...
### 报告问题
如果你发现了一个 bug、有功能请求或者对项目有任何建议，请在项目的 [GitHub Issues](https://github.com/CUNLITOU/go-stock/issues) 中创建一个新的 issue。在创建 issue 时，请提供尽可能多的信息，包括：
...
```bash
git remote add upstream https://github.com/CUNLITOU/go-stock.git
git fetch upstream
